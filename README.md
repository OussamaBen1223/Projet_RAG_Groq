...
![Screenshot de l'application](https://via.placeholder.com/800x400.png?text=Projet+RAG+Plateforme) *(ajoutez une vraie capture d'écran ici si vous le souhaitez)*
